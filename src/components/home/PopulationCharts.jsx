...
export function FertilizerChart({ isAdmin, getHomeImg, setHomeImg }) {
  return (
    <motion.div
      ...
      className="rounded-2xl border border-white/10 bg-white p-6 sm:p-8"
    >
      <h3 className="text-2xl sm:text-3xl font-bold text-black mb-1">
        Fertilizer fed <span className="text-green-500">6 billion people</span>
      </h3>
      <p className="text-black/50 text-sm italic mb-1 max-w-md">
