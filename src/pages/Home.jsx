        ...
        <div className="mt-3 mb-0 lg:mb-0">
          <div className="flex flex-wrap gap-3">
            ...
            <Button
              ...
              <img src="https://media.base44.com/images/public/6993b7c68cee7955d3266d09/44c585a4a_SaltwaterFarming_Transparent.png" alt="Saltwater Farms" className="w-5 h-5 object-contain" />
              Saltwater Farms
            </Button>
          </div>
          {selectedPhase === "Seawater Greenhouse" && (
